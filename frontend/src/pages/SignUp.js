      ...
      <div className="mx-auto container p-4">
        <div className="bg-white p-5 w-full max-w-sm mx-auto ">
          <div className="w-24 h-24 mx-auto relative overflow-hidden rounded-full">
            ...
            <form>
              <label>
                <div className="text-xs bg-opacity-80 bg-slate-200 pb-4 pt-1 cursor-pointer absolute bottom-0 text-center w-full">
                  Upload Photo
                </div>
                <input
                  type="file"
                  className="hidden"
                  onChange={handleUplaodPic}
                />
              </label>
            </form>
          </div>
